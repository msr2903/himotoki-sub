...
- **New words only (beta)**: pick your JLPT level (N3, N2 or N1) and the subtitles blur every word at or below it, keeping only harder JLPT words and rare ones; hover a word or press `H` to see the whole line.
