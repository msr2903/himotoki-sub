...
| Save to Himotoki | The word, its reading and gloss, the sentence it appeared in, the video URL, video title and timestamp | Himotoki's account storage (Google Firebase: Firebase Auth for sign-in, Cloud Firestore for your saved words) | Only when you are signed in and press Save |
